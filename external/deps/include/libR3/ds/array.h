...
R3_PUBLIC_API ptr r3NewArrayEX(u64 slots, u16 stride, ptr data);
...
R3_PUBLIC_API R3Result r3ClearArray(ptr array);
R3_PUBLIC_API i64 r3InArray(ptr value, ptr array);
R3_PUBLIC_API R3Result r3PopArray(ptr array, ptr dest);
R3_PUBLIC_API R3Result r3PushArray(ptr value, ptr array);
R3_PUBLIC_API R3Result r3SwapPopArray(u32 slot, ptr array);
...
R3_PUBLIC_API i64 r3InArrayEX(ptr value, ptr array, R3CompareFNPTR cmp);
