...
R3_PUBLIC_API R3Result r3SetStringFlags(R3StringFlag flag, char* string);
R3_PUBLIC_API R3Result r3RemStringFlags(R3StringFlag flag, char* string);
R3_PUBLIC_API R3Result r3StringHeader(R3StringHeader* header, char* string);

R3_PUBLIC_API u64 r3StringLen(char* string);
R3_PUBLIC_API u64 r3StringReads(char* string);
R3_PUBLIC_API u64 r3StringWrites(char* string);
R3_PUBLIC_API u64 r3StringCursor(char* string);
...
R3_PUBLIC_API R3Result r3CompareString(u64 chars, char* cmp, char* src);
