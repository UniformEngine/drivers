...
R3_PUBLIC_API R3Result r3SetFileFlags(R3FileFlag flags, ptr file);
R3_PUBLIC_API R3Result r3RemFileFlags(R3FileFlag flags, ptr file);
R3_PUBLIC_API R3Result r3FileHeader(R3FileHeader* header, ptr file);

R3_PUBLIC_API u64 r3FileSize(ptr file);
R3_PUBLIC_API u32 r3FileReads(ptr file);
R3_PUBLIC_API u32 r3FileWrites(ptr file);
R3_PUBLIC_API u64 r3FileCursor(ptr file);
